...
describe("delPosition",function(){
    it("[8,5,2,4,7] ind=3 => 4",function() {
        assert.equal(delPos.delPos(3), 4)
    });
    it("[8,5,2,7] ind=3 => 7",function() {
        assert.equal(delPos.delPos(3), 7)
    });
});
...
let sortn = new aList([8,5,2,4,7])
describe("sort",function(){
    it("[8,5,2,4,7] => [2,4,5,7,8]", function() {
        assert.deepEqual(sortn.sort(), [2,4,5,7,8])
    });
});
...
describe("addPosition", function(){
    ...
    it("[8,5,2,4,7] elem=10, ind=3 => [8,5,2,10,4,7]", function() {
        assert.deepEqual(addPos.array, [8,5,2,10,4,7])
    });
});